...
class CategoriasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'icon' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-10-15 05:02:05',
            'modified' => '2016-10-15 05:02:05'
        ],
    ];
}
